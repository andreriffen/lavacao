CREATE DATABASE IF NOT EXISTS db_lavacao-mvn;
USE db_lavacao-mvn;
...
INSERT INTO cliente(nome, celular, email, endereco, dataCadastro) VALUES('Edgar','(11) 1111-1111', 'edgar@ifsc.edu.br', 'Rua Wenceslau Corrêa de Souza', '1996-08-17');
INSERT INTO pessoa_fisica(id_cliente, cpf, dataNascimento) VALUES((SELECT max(id) FROM cliente), '111.111.111-11','1970-04-20');
INSERT INTO cliente(nome, celular, email, endereco, dataCadastro) VALUES('Marilene','(22) 2222-2121', 'marilene@ifsc.edu.br', 'Quadra 1007 Sul Alameda 1 A', '2003-06-02');
INSERT INTO pessoa_fisica(id_cliente, cpf, dataNascimento) VALUES((SELECT max(id) FROM cliente), '222.222.222-22', '1979-10-18');
INSERT INTO cliente(nome, celular, email, endereco, dataCadastro) VALUES('Carla','(33) 3333-3333', 'carla@ifsc.edu.br','Rua Santo Antônio', '1986-12-12');
INSERT INTO pessoa_juridica(id_cliente, cnpj, inscricaoEstadual, dataNascimento) VALUES((SELECT max(id) FROM cliente), '11.719.809/0001-94', '040.240.270.481', '1977-02-01');
INSERT INTO cliente(nome, celular, email, endereco, dataCadastro) VALUES('José','(44) 4444-4444', 'jose@ifsc.edu.br', 'Rua Isaura da Sílvia', '1968-03-07');
INSERT INTO pessoa_juridica(id_cliente, cnpj, inscricaoEstadual, dataNascimento) VALUES((SELECT max(id) FROM cliente), '11.719.809/0001-94', '720.324.234.299', '1975-08-27');
...
INSERT INTO servico(descricao, valor, pontos, categoria) VALUES('Lavação Pequena', 75.50, 20, 'PEQUENO');
INSERT INTO servico(descricao, valor, pontos, categoria) VALUES('Lavação Média', 115.25, 45, 'MEDIO');
INSERT INTO servico(descricao, valor, pontos, categoria) VALUES('Lavação Grande', 180, 75, 'GRANDE');
